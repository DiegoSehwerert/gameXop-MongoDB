...
exports.create = (req, res) => {
  LocaleSeoSlug.create(req.body).then(data => {
...
exports.findOne = (req, res) => {
  ...
  LocaleSeoSlug.findByPk(id).then(data => {
    if (data) {
      res.status(200).send(data)
    } else {
      res.status(404).send({
